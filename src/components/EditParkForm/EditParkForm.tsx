...
import { editParkThunk } from "../../redux/thunks/parkThunk/parkThunk";
import { IAddress, IPark, ParkDetail } from "../../redux/types/parkInterfaces";
import Map from "../Map/Map";
import { EditParkFormStyles } from "./EditParkFormStyles";
...
export interface EditParkFormProps {
  currentPark: IPark;
}

const EditParkForm = ({ currentPark }: EditParkFormProps) => {
  const [parkLocation, setParkLocation] = useState<[number, number]>([0, 0]);

  const [park, setPark] = useState({ ...currentPark });
